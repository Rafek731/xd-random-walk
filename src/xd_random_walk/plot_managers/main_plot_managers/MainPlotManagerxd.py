...
class MainPlotManagerxd(BaseMainPlotManager):
    """Manages an auto-formatting grid of 1D number lines to visualize >3 dimensions."""
    ...
    def _get_optimal_grid(
        self, n_items: int, aspect_ratio: float = 16 / 9
    ) -> tuple[int, int]:
        """Calculates rows and columns to fit n_items within a desired aspect ratio."""
