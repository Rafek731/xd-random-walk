...
class AvgDistanceManager:
    ...
    def __init__(self) -> None:
        ...
        self._avg_line = self._ax.plot([], [], label="Current Step Avg", color="blue")[0]
        self._regression_line = self._ax.plot([], [], label="a*sqrt(N)", color="red", linestyle="--")[0]
    ...
    def _fit_a(self):
        ...
        np_avgs_points = np.array(self._averages)
        np_regr_points = np.arange(1, self._step + 1)
